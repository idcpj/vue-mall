        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <span v-if="nikeName" v-text="nikeName" ></span>
...
//          nikeName:"",
    ...
    methods:{
      checkLogin(){
        axios.get(config.api.userCheckLogin).then(response=>{
      ...
      login(){
          this.loginModalFlag=true;//显示弹框
          if (!this.userName || !this.userPwd) {
               this.errorTip =true;
              return;
          }

          let param={userName:this.userName,userPwd:this.userPwd};
        axios.post(config.api.userLogin,param)
        .then(response=>{
