                ...
                <div class="checkout-addr">
                    ...
                    <div class="addr-list-wrap">
                        ...
                        <div class="shipping-addr-more">
                            <a  @click="AddressMore" :class="{'open':limitAddress>3}" class="addr-more-btn up-down-btn" href="javascript:;">
                                more
                                <i class="i-up-down">
...
export default {
    ...
    methods:{
        init(){
            axios.get(config.api.userAddress).then(response=>{
        ...
        AddressMore(){
            if (this.limitAddress==3){
                this.limitAddress=this.address.length;
            }else{
                this.limitAddress=3;
            }
        },
    ...
    computed:{
      addressLImit(){
          return this.address.slice(0,this.limitAddress);
      }
    },
    components: {
        NavBread
